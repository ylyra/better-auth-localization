...
export const NL_NL_INFORMAL = {
  ...
  USER_ALREADY_HAS_PASSWORD: "Gebruiker heeft al een wachtwoord. Voer het in om het account te verwijderen.",

  // Session related errors
  FAILED_TO_CREATE_SESSION: "Sessie kon niet worden aangemaakt",
  FAILED_TO_GET_SESSION: "Sessie kon niet worden opgehaald",
  SESSION_EXPIRED: "Sessie verlopen. Log opnieuw in om deze actie uit te voeren.",
